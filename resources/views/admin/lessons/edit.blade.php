    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.lessons.update", [$lesson->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control editor {{ $errors->has('long_text') ? 'is-invalid' : '' }}" name="long_text" id="long_text">{{ old('long_text', $lesson->long_text) }}</textarea>
            ...
            <div class="form-group">
                <label class="" for="meta_title">{{ trans('cruds.lesson.fields.meta_title') }}</label>
                <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $lesson->meta_title) }}" >
            ...
            <div class="form-group">
                <label class="" for="meta_keyword">{{ trans('cruds.lesson.fields.meta_keyword') }}</label>
                <input class="form-control {{ $errors->has('meta_keyword') ? 'is-invalid' : '' }}" type="text" name="meta_keyword" id="meta_keyword" value="{{ old('meta_keyword', $lesson->meta_keyword) }}" >
            ...
            <div class="form-group">
                <label class="" for="meta_description">{{ trans('cruds.lesson.fields.meta_description') }}</label>
                <input class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $lesson->meta_description) }}" >
