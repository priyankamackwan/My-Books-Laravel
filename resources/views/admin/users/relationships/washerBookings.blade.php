...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-washerBookings">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.booking.fields.washer') }}
                        </th>
                        <th>
                            {{ trans('cruds.booking.fields.car') }}
                        </th>
                        <th>
                            {{ trans('cruds.booking.fields.parking_code') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($bookings as $key => $booking)
                        <tr data-entry-id="{{ $booking->id }}">
                            ...
                            <td>
                                {{ $booking->parking_code->location_code ?? '' }}
                            </td>
                            <td>
                                {{ App\Models\Booking::STATUS_RADIO[$booking->status] ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-washerBookings:not(.ajaxTable)').DataTable({ buttons: dtButtons })
