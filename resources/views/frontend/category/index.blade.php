@section('meta_tags')
<title>TechedHub Solution Category Courses</title>
 ...
 <!-- PAGE TITLE
    ...
    style="background-image: url({{ asset('img/covers/cover-19.jpg') }});">
        <div class="container text-center py-xl-5">
            <h1 class="display-4 fw-semi-bold mb-0 text-white">All Categories</h1>
                ...
                <div class="col-md pb-4 pb-md-7">
                    ...
                    <div class="card card-border-hover border shadow-dark-hover p-2 lift sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            ...
                            <a href="{{ route('frontend.category.course', $category->slug) }}" class="card-img sk-thumbnail d-block">
                                <img class="rounded shadow-light-lg"  src="{{ asset('images/category.jpg')}}" alt="">
                            </a>
                        ...
                        <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            ...
                            <div class="position-relative">
                                <a href="{{ route('frontend.category.course', $category->slug) }}" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">{{$category->category_name }}</h4></a>
                                        ...
                                        <ul class="nav mx-n3">
                                            <li class="nav-item px-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @if(isset($category->courseLessons) && count($category->courseLessons)>0)
                                                        <!-- Icon -->
                                                        ...
                                                        <div class="font-size-sm"> {{($category->courseCategoryCourses)}} Course</div>    
                                                    @endif
